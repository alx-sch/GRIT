        ...
        <div className="relative">
          ...
          {isGeneratedAvatar && (
            <button
              ...
              className={cn(
                'absolute bottom-0 right-0 w-12 h-12 md:w-8 md:h-8 rounded-full bg-primary text-primary-foreground shadow-lg flex items-center justify-center border-2 border-background transition-all',
